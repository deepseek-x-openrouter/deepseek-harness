...
<a id="llm-pi-aiprovider-response--emit"></a>

#### `llm-pi-ai/provider-response` — emit

One provider HTTP response arrived, reported by status and headers before its body is read.
 ...
 * @mode emit
 */
'llm-pi-ai/provider-response'(detail: { provider: string model: string status: number headers: Readonly<Record<string, string>> }): void
```
